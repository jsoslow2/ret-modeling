...
changing_new_users <- function(ret_list, new_user_base, change_in_new_users, change_in_retention = 0) {
...
optimization <- function(d1, d7, d30, new_users, change_in_new_users = 0, change_in_retention = 0) {
  ...
  if ((change_in_new_users != 0) | (change_in_retention != 0)) {
    df = changing_new_users(ret, new_users, change_in_new_users, change_in_retention)
  } else {
